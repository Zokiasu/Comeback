<template>
  <div class="p-5 lg:p-10 flex flex-col sm:mx-auto">
    <div class="bg-black-one w-full rounded-lg p-5 lg:max-w-full mx-auto">
      <h2 class="text-tertiary text-3xl font-semibold mb-3">Edit Artist</h2>
      <div class="flex flex-wrap gap-5">
          ...
          <div class="w-full">
            ...
            <input
              ...
              class="
                ...
                focus:bg-tertiary focus:border-gray-500
              "
            />
          </div>
          <!-- Youtube Music Id -->
        ...
        <div class="w-full flex justify-end">
          <button
            class="bg-red-one px-4 py-2 rounded text-tertiary font-semibold"
            @click="updateArtist()"
          >
            Update Artist
          </button>
